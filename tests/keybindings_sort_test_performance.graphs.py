...
Usage:
    keybindings_sort_test_performance.graphs.py
    keybindings_sort_test_performance.graphs.py --input tests/data/perf-keybindings-sort.full.csv --out-dir tests/data

Behavior:
- reads a benchmark CSV generated by keybindings_sort_test_performance.py
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="input CSV file generated by keybindings_sort_test_performance.py",
    )
    parser.add_argument(
        "--out-dir",
        default="tests/data",
